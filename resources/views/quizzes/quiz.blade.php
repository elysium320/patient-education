...
<div class="home-page">
    <h1 class="heading-primary">
        <a href="/lessons/{{ $quiz->lesson_id }}">{{ $quiz->title }}</a>
    </h1>
    <h2 class="heading-secondary">{{ __('Please read and answer each question. Then press “Submit” to move on to the next')}}</h2>

    <h2 class="heading-secondary">{{ __('question and “Previous” to go back to any question you have already answered.')}}</h2>
    <quiz-component :quiz="{{ $quiz }}"></quiz-component>
